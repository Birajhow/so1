...
Use ctrl + f para achar as seções

1--STRUCTURES
2--DECLARAÇÃO DE FUNCTIONS
3--CONSTANTES E GLOBAIS
4--MAIN
5--IMPLEMENTAÇÃO DE FUNCTIONS
...
//------------------------------------------------------------------------------
//--2--DECLARAÇÃO DE FUNCTIONS--INICIO------------------------------------------
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
//--DECLARAÇÃO DE FUNCTIONS--FIM------------------------------------------------
//------------------------------------------------------------------------------

//------------------------------------------------------------------------------
//--3--CONSTANTES E GLOBAIS--INICIO---------------------------------------------
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
//--5--IMPLEMENTAÇÃO DE FUNCTIONS--INICIO---------------------------------------
//------------------------------------------------------------------------------
...
color shade(camera cam,point *incid ,enum object obj, int index, point *p, int iter) {
  ...
  } else if(obj == SPHERE) { //for spheres...
    if(data[index].kf > 0) {
      r_sec.o.x = p->x;
      r_sec.o.y = p->y;
      r_sec.o.z = p->z;
...
//------------------------------------------------------------------------------
//--IMPLEMENTAÇÃO DE FUNCTIONS--FIM---------------------------------------------
//------------------------------------------------------------------------------
