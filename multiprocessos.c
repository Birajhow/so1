...
// ~~Comment1: parte do processo pai
...
int main(int argc, char ** argv)
{
    ...
    clock_t tempoInicial, tempoFinal;
   	...
   	// Comment3: Inicialização de Câmera
    int i,j;
    uchar *image;
    camera c;
    point eye;
    ...
    //Fim Inicialização de Câmera


    //Comment4 : Malloc do quadro (Gera Ambiente 3D)
